...
import (
	...
	math2 "github.com/lifefile/life-file/common/math"
...
// newAlethGenesisSpec converts a life-file genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between life-file and aleth
...
// newParityChainSpec converts a life-file genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between life-file and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	// https://github.com/lifefile/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/lifefile/EIPs/blob/master/EIPS/eip-607.md
...
// pyLifeFileGenesisSpec represents the genesis specification format used by the
// Python LifeFile implementation.
...
// newPyLifeFileGenesisSpec converts a life-file genesis block into a Parity specific
// chain specification format.
