...
type wizard struct {
	...
	services map[string][]string   // LifeFile services known to be running on servers
...
// converts it to an LifeFile address. If an empty line is entered, the default
// value is returned.
