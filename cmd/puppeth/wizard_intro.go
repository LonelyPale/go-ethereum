...
// setting up a new or managing an existing LifeFile private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your LifeFile private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new LifeFile network down to  |")
	...
	log.Info("Administering LifeFile network", "name", w.network)
