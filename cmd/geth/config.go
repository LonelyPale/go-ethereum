...
import (
	...
	"github.com/lifefile/life-file/eth/catalyst"
...
// makeFullNode loads geth configuration and creates the LifeFile backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the LifeFile Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
