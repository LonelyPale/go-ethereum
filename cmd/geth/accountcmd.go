...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage LifeFile presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import LifeFile presale wallet",
				ArgsUsage: "<keyFile>",
...
betweenlifefile.nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to anotherlifefile.instance,
