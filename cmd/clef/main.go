...
import (
	...
	"github.com/lifefile/life-file/signer/fourbyte"
	"github.com/lifefile/life-file/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage LifeFile account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/lifefile/life-file/issues/20123
