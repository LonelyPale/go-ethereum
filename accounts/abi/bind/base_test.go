...
func (mc *mockCaller) CallContract(ctx context.Context, call lifefile.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call lifefile.CallMsg) ([]byte, error) {
