...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // LifeFile blockchain to handle the consensus
...
func (b *SimulatedBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, lifefile.NotFound
}
...
// See: https://github.com/lifefile/wiki/wiki/JSON-RPC-Error-Codes-Improvement-Proposal
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call lifefile.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call lifefile.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call lifefile.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call lifefile.CallMsg, block *types.Block, stateDB *state.StateDB) (*core.ExecutionResult, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query lifefile.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query lifefile.FilterQuery, ch chan<- types.Log) (lifefile.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (lifefile.Subscription, error) {
