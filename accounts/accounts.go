...
// Package accounts implements high level LifeFile account management.
package accounts
...
// Account represents an LifeFile account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // LifeFile account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain lifefile.ChainStateReader)
...
//   keccak256("\x19LifeFile Signed Message:\n"${message length}${message}).
//
