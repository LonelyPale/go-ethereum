...
import (
	...
	"github.com/lifefile/life-file/les/vflux"
...
// APIs returns the collection of RPC services thelifefile.package offers.
...
// lightlifefile.protocol implementation.
...
func (s *LightEthereum) Stop() error {
	...
	s.lesDb.Close()
	s.wg.Wait()
	log.Info("Lightlifefile.stopped")
	return nil
}
