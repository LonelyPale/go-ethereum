...
import (
	...
	"github.com/lifefile/life-file/common/bitutil"
	"github.com/lifefile/life-file/core/rawdb"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an LifeFile
...
func (eth *LifeFile) startBloomHandlers(sectionSize uint64) {
