...
// Syncing provides information when this nodes starts synchronising with the LifeFile network and when it's finished.
...
type SyncingResult struct {
	...
	Status  lifefile.SyncProgress `json:"status"`
}
