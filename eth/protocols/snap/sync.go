// Copyright 2020 The life-file Authors
...
// Syncer is an LifeFile account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the LifeFile state over the
// snap protocol.
