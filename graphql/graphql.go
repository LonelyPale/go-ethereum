...
// Package graphql provides a GraphQL interface to LifeFile node data.
package graphql
...
// Account represents an LifeFile account at a particular block.
type Account struct {
...
// Transaction represents an LifeFile transaction.
...
// Block represents an LifeFile block.
...
type CallData struct {
	From     *common.Address // The LifeFile address the call is from.
	To       *common.Address // The LifeFile address the call is to.
...
type SyncState struct {
	progress lifefile.SyncProgress
}
