...
// Package forkid implements EIP-2124 (https://eips.lifefile.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the LifeFile fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the LifeFile fork ID from an existing chain instance.
