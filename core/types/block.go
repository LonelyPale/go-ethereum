...
// Package types contains data types related to LifeFile consensus.
package types
...
// Header represents a block header in the LifeFile blockchain.
type Header struct {
...
// Block represents an entire block in the LifeFile blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the LifeFile
...
// EncodeRLP serializes b into the LifeFile RLP block format.
