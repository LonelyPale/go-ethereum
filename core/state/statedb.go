...
// Package state provides a caching layer atop the LifeFile state trie.
package state
...
import (
	...
	"github.com/lifefile/life-file/core/state/snapshot"
...
// StateDB structs within thelifefile.protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/lifefile/life-file/pull/16485#issuecomment-380438527),
