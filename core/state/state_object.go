...
// stateObject represents an LifeFile account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash oflifefile.address of the account
	data     Account
	db       *StateDB
...
// Account is the LifeFile consensus representation of accounts.
