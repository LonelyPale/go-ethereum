...
import "github.com/lifefile/life-file/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main LifeFile network.
var MainnetBootnodes = []string{
	// LifeFile Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/lifefile/discv4-dns-lists for more
// information.
