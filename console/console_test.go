...
import (
	...
	"github.com/lifefile/life-file/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an LifeFile service within
	...
	if err != nil {
		t.Fatalf("failed to register LifeFile protocol: %v", err)
	}
