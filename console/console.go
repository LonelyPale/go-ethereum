...
import (
	...
	"github.com/lifefile/life-file/internal/jsre/deps"
	"github.com/lifefile/life-file/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute LifeFile requests through
