...
// mapped from textual names used in the tests below to actual LifeFile private
...
// address retrieves the LifeFile address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the LifeFile address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/lifefile/life-file/issues/17593). Whilst this
