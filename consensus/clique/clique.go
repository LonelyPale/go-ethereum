...
import (
	...
	"github.com/lifefile/life-file/consensus/misc"
...
// ecrecover extracts the LifeFile account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the LifeFile address
...
// LifeFile testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // LifeFile address of the signing key
...
// Author implements consensus.Engine, returning the LifeFile address recovered
