...
// This test reproduces https://github.com/lifefile/life-file/issues/17837 where the
...
// It is the reproducer for https://github.com/lifefile/life-file/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("life-file-test-ipc-%d-%d", os.Getpid(), rand.Int63())
